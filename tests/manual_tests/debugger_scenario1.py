...
repo_directory = Path(__file__).parents[2].resolve()
...
folder_with_project_files = repo_directory.joinpath("tests", "manual_tests", "projects_files", "debugger_scenario_1_files")
