...
def files_in_directory(
    ...
    for directory in directories_with_files_to_describe:
        ...
        tmp = [evaluate_file(root=str(directory),
                             file=file,
...
def output_descriptions(files_to_describe: list[Path], chain: RunnableSequence, file_description_dir: str, work_dir: str) -> None:
