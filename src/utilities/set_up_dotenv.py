...
def set_up_env_coder_pipeline():
    ...
    envs["ANTHROPIC_API_KEY"] = input("Provide your Anthropic API key (Optional) (Best coding capabilities):\n")
    envs["OPENAI_API_KEY"] = input("Provide your OpenAI API key (Optional) (Needed for using microphone, best planning capabilities with o1):\n")
    envs["OPEN_ROUTER_API_KEY"] = input("Provide your Open Router API key (Optional) (All models in one place):\n")
    envs["OLLAMA_MODEL"] = input("Provide your Ollama model name (Optional) (If you want to use self-hosted model instead):\n")
